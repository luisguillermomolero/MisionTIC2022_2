 ...
 * CA: puede extender solo una clase abstracta.
 * I: puede implementar más de una interfaz.
 * CA: las variables no son definitivas por defecto. Puede contener variables no
 * finales.
 ...
 * I: una interfaz no puede proporcionar la implementación de una clase
 * abstracta.
 * CA: puede tener métodos con implementaciones.
 * I: proporciona una abstracción absoluta y no puede tener implementaciones de
 * métodos.
 * CA: puede tener modificadores de acceso públicos, privados, estáticos y
 * protegidos.
 * I: los métodos son implícitamente públicos y abstractos en la interfaz de
 * Java.
 * CA: no admite herencias múltiples.
 * I: es compatible con herencias múltiples.
 * CA: es ideal para la reutilización del código y la perspectiva de la
 * evolución.
