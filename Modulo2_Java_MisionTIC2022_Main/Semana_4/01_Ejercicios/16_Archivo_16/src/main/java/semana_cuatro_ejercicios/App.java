//Programa Java que lee el contenido del fichero creado en el Ejemplo anterior y lo muestra por pantalla.
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            for (int i = 0; i < filas; i++) {
                for (int j = 0; j < columnas; j++) { // se leen los double y se muestran por pantalla
